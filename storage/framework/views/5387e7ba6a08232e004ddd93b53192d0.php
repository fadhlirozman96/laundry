...
<?php $__env->startSection('content'); ?>
    <div class="account-content">
        <div class="login-wrapper">
                    ...
                    <div class="login-userset">
                        ...
                        <div class="form-login">
                            ...
                            <div class="form-addons">
                                ...
                                <img src="<?php echo e(URL::asset('/build/img/icons/user-icon.svg')); ?>" alt="img">
                            </div>
                        </div>
                        <div class="form-login">
                        ...
                        <div class="signinform">
                            <h4>Already have an account ? <a href="<?php echo e(url('signin-2')); ?>" class="hover-a">Sign In
                                    Instead</a></h4>
                        </div>
            ...
            <div class="login-img">
                <img src="<?php echo e(URL::asset('/build/img/authentication/register02.png')); ?>" alt="img">
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laundry\resources\views/register-2.blade.php ENDPATH**/ ?>