    ...
    <div class="content">
        <div class="page-header">
            ...
            <ul class="table-top-head">
                <li><a data-bs-toggle="tooltip" data-bs-placement="top" title="Pdf"><img src="<?php echo e(URL::asset('/build/img/icons/pdf.svg')); ?>" alt="img"></a></li>
                <li><a data-bs-toggle="tooltip" data-bs-placement="top" title="Excel"><img src="<?php echo e(URL::asset('/build/img/icons/excel.svg')); ?>" alt="img"></a></li>
        ...
        <?php if(session('selected_store_id')): ?>
...
$(document).ready(function() {
    ...
    $('#add-coupon-form').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(route("coupons.store")); ?>',
            type: 'POST',
            data: $(this).serialize(),
...
function generateCode(type) {
    ...
    $.get('<?php echo e(route("coupons.generate-code")); ?>', { name: name }, function(response) {
        if (response.success) {
            if (type === 'add') {
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laundry\resources\views/coupons.blade.php ENDPATH**/ ?>