                                        ...
                                        <ul class="w-100 d-flex justify-content-between align-items-center">
                                            <li class="storage-icon mb-0">
                                                <span class="system-app-icon">
                                                    <img src="<?php echo e(URL::asset('/build/img/icons/storage-icon-01.svg')); ?>"
                                                        alt="">
                                                </span>
                                                <h6>Local Storage</h6>
                                            </li>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 d-flex">
                                    <div class="connected-app-card d-flex w-100">
                                        <ul class="w-100 d-flex justify-content-between align-items-center">
                                            <li class="storage-icon mb-0">
                                                <span class="system-app-icon">
                                                    <img src="<?php echo e(URL::asset('/build/img/icons/storage-icon-02.svg')); ?>"
                                                        alt="">
                                                </span>
                                                <h6>AWS</h6>
                                            </li>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laundry\resources\views/storage-settings.blade.php ENDPATH**/ ?>