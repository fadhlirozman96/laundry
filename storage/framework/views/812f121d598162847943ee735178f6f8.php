...
<div class="header header-responsive" style="display: flex; align-items: center;">
    ...
    <ul class="nav user-menu user-menu-responsive" style="margin-left: auto; display: flex; align-items: center; justify-content: flex-end; flex: 1;">
        ...
        <li class="nav-item pos-btn-nav me-3">
            <a href="<?php echo e(url('pos')); ?>" class="btn btn-primary d-flex align-items-center" style="padding: 8px 20px; white-space: nowrap;" title="POS System">
        ...
        <li class="nav-item dropdown has-arrow main-drop">
            <a href="javascript:void(0);" class="dropdown-toggle nav-link userset" data-bs-toggle="dropdown">
                <span class="user-info">
                    <span class="user-letter">
                        <img src="<?php echo e(URL::asset('/build/img/profiles/avator1.jpg')); ?>" alt="" class="img-fluid">
                    </span>
                    <span class="user-detail">
            ...
            <div class="dropdown-menu menu-drop-user">
                <div class="profilename">
                    <div class="profileset">
                        <span class="user-img"><img src="<?php echo e(URL::asset('/build/img/profiles/avator1.jpg')); ?>" alt="">
                    ...
                    <a class="dropdown-item" href="<?php echo e(url('general-settings')); ?>"><i class="me-2" data-feather="settings"></i>Settings</a>
                    <?php endif; ?>
                    <hr class="m-0">
                    <a class="dropdown-item logout pb-0" href="<?php echo e(route('logout')); ?>"><img src="<?php echo e(URL::asset('/build/img/icons/log-out.svg')); ?>" class="me-2" alt="img">Logout</a>
                </div>
            </div>
        </li>
    </ul>
