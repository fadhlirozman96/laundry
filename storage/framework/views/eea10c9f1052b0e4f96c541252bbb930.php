            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="settings-wrapper d-flex">
                        <?php $__env->startComponent('components.settings-sidebar'); ?>
                                                ...
                                                <div class="d-flex align-items-center justify-content-between w-100">
                                                    <div class="security-type d-flex align-items-center">
                                                        <span class="system-app-icon">
                                                            <img src="<?php echo e(URL::asset('/build/img/icons/app-icon-07.svg')); ?>"
                                                                alt="">
                                                        </span>
                                        ...
                                        <ul class="w-100">
                                            <li class="flex-column align-items-start">
                                                <div class="d-flex align-items-center justify-content-between w-100">
                                                    <div class="security-type d-flex align-items-center">
                                                        <span class="system-app-icon">
                                                            <img src="<?php echo e(URL::asset('/build/img/icons/app-icon-08.svg')); ?>"
                                                                alt="">
                                                        </span>
                                                        <div class="security-title">
                                        ...
                                        <ul class="w-100">
                                            <li class="flex-column align-items-start">
                                                <div class="d-flex align-items-center justify-content-between w-100">
                                                    <div class="security-type d-flex align-items-center">
                                                        <span class="system-app-icon">
                                                            <img src="<?php echo e(URL::asset('/build/img/icons/app-icon-09.svg')); ?>"
                                                                alt="">
                                                        </span>
                                                        <div class="security-title">
                                        ...
                                        <ul class="w-100">
                                            <li class="flex-column align-items-start">
                                                <div class="d-flex align-items-center justify-content-between w-100">
                                                    <div class="security-type d-flex align-items-center">
                                                        <span class="system-app-icon">
                                                            <img src="<?php echo e(URL::asset('/build/img/icons/app-icon-10.svg')); ?>"
                                                                alt="">
                                                        </span>
                                                        <div class="security-title">
                                                            <h5>Google Map</h5>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laundry\resources\views/system-settings.blade.php ENDPATH**/ ?>