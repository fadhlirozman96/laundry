...
<?php if(Route::is(['expired-products'])): ?>
    <!-- Add PDF -->
    <div class="modal fade" id="add-units">
        <div class="modal-dialog modal-dialog-centered custom-modal-two">
            <div class="modal-content">
...
<?php if(Route::is(['file-document', 'file-favourites', 'file-archived'])): ?>
    <!-- Files Toogle Slide -->
    <div class="toggle-sidebar">
        <div class="d-flex align-items-center justify-content-between head">
            <h4>File Preview</h4>
...
<?php if(Route::is(['attendance-employee'])): ?>
		<!-- Add Attendance -->
		<div class="modal fade" id="add-units">
			<div class="modal-dialog modal-dialog-centered custom-modal-two">
				<div class="modal-content">
...
<?php if(Route::is(['ban-ip-address'])): ?>
		<!-- Add BanIp -->
...
<?php if(Route::is(['bank-settings-grid'])): ?>
		<!-- Add Bank Account -->
...
<?php if(Route::is(['bank-settings-list'])): ?>
		<!-- Add Bank Account -->
		<div class="modal fade" id="add-account">
			<div class="modal-dialog modal-dialog-centered custom-modal-two">
				<div class="modal-content">
...
<?php if(Route::is(['currency-settings'])): ?>
		<!-- Add Currency -->
...
<?php if(Route::is(['department-grid','department-list'])): ?>
		<!-- Add Department -->
...
<?php if(Route::is(['email-settings'])): ?>
		<!-- Php Mail -->
...
<?php if(Route::is(['payment-gateway-settings'])): ?>
		<!-- Php Mail -->
...
<?php if(Route::is(['printer-settings'])): ?>
		<!-- Add Printer -->
...
<?php if(Route::is(['social-authentication'])): ?>
		<!-- Connect Facebook -->
...
<?php if(Route::is(['storage-settings'])): ?>
		<!-- Aws Config -->
...
<?php if(Route::is(['system-settings'])): ?>
		<!-- Google Captcha -->
...
<?php if(Route::is(['countries'])): ?>
		...
		<!-- /Edit Supplier -->
<?php endif; ?><?php /**PATH C:\laragon\www\laundry3\resources\views/components/modalpopup.blade.php ENDPATH**/ ?>