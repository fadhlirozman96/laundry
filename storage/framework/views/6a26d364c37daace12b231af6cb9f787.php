                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center mb-4">
                            ...
                            <h2 class="text-primary">MYR <?php echo e(number_format($plan->price, 0)); ?><small>/month</small></h2>
                            <p class="text-muted">or MYR <?php echo e(number_format($plan->annual_price, 0)); ?>/year</p>
                            ...
                            <span class="badge bg-info"><?php echo e($plan->subscriptions->where('status', 'active')->count()); ?> Active Subscribers</span>
                        </div>
                        ...
                        <div class="mt-4">
                            <a href="<?php echo e(route('superadmin.plans.edit', $plan->id)); ?>" class="btn btn-primary btn-block">
