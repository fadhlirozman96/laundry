...
<?php $__env->startSection('content'); ?>
    <div class="page-wrapper">
        <div class="content">
            <?php if(isset($viewAllStores) && $viewAllStores): ?>
            ...
            <div class="row">
                <div class="col-xl-3 col-sm-6 col-12 d-flex">
                    <div class="dash-widget w-100">
                        <div class="dash-widgetimg">
                            <span><img src="<?php echo e(URL::asset('/build/img/icons/dash1.svg')); ?>" alt="img"></span>
                        </div>
                        <div class="dash-widgetcontent">
                            <h5>MYR <span class="counters" data-count="<?php echo e(number_format($totalSalesToday, 2, '.', '')); ?>"><?php echo e(number_format($totalSalesToday, 2)); ?></span></h5>
                ...
                <div class="col-xl-3 col-sm-6 col-12 d-flex">
                    <div class="dash-widget dash1 w-100">
                        <div class="dash-widgetimg">
                            <span><img src="<?php echo e(URL::asset('/build/img/icons/dash2.svg')); ?>" alt="img"></span>
                        </div>
                        <div class="dash-widgetcontent">
                            <h5><span class="counters" data-count="<?php echo e($totalOrderToday); ?>"><?php echo e(number_format($totalOrderToday)); ?></span></h5>
                ...
                <div class="col-xl-3 col-sm-6 col-12 d-flex">
                    <div class="dash-widget dash2 w-100">
                        <div class="dash-widgetimg">
                            <span><img src="<?php echo e(URL::asset('/build/img/icons/dash3.svg')); ?>" alt="img"></span>
                        </div>
                        <div class="dash-widgetcontent">
                            <h5>MYR <span class="counters" data-count="<?php echo e(number_format($totalSalesThisYear, 2, '.', '')); ?>"><?php echo e(number_format($totalSalesThisYear, 2)); ?></span></h5>
                ...
                <div class="col-xl-3 col-sm-6 col-12 d-flex">
                    <div class="dash-widget dash3 w-100">
                        <div class="dash-widgetimg">
                            <span><img src="<?php echo e(URL::asset('/build/img/icons/dash4.svg')); ?>" alt="img"></span>
                        </div>
                        <div class="dash-widgetcontent">
                            <h5>MYR <span class="counters" data-count="<?php echo e(number_format($totalSalesOverall, 2, '.', '')); ?>"><?php echo e(number_format($totalSalesOverall, 2)); ?></span></h5>
                ...
                <div class="col-xl-3 col-sm-6 col-12 d-flex">
                    <div class="dash-count das1">
                        <div class="dash-counts">
                            <h4><?php echo e(number_format($purchaseInvoiceCount)); ?></h4>
                            <h5>Purchase Invoice</h5>
                        </div>
                        <div class="dash-imgs">
                            <img src="<?php echo e(URL::asset('/build/img/icons/file-text-icon-01.svg')); ?>" class="img-fluid"
                                alt="icon">
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 col-12 d-flex">
                    <div class="dash-count das2">
                        <div class="dash-counts">
                            <h4><?php echo e(number_format($salesInvoiceCount)); ?></h4>
                            <h5>Sales Invoice</h5>
                        </div>
                        <div class="dash-imgs">
                ...
                <div class="col-xl-3 col-sm-6 col-12 d-flex">
                    <div class="dash-count das3">
                        <div class="dash-counts">
                            <h4><?php echo e(number_format($totalOrderToday)); ?></h4>
                            <h5>Orders Today</h5>
                        </div>
                        <div class="dash-imgs">
            ...
            <div class="row">
                <div class="col-xl-7 col-sm-12 col-12 d-flex">
                    <div class="card flex-fill">
                            ...
                            <div class="graph-sets">
                                ...
                                <div class="dropdown dropdown-wraper">
                                    <button class="btn btn-light btn-sm dropdown-toggle" type="button"
                                        ...
                                        <span id="selected-year-display"><?php echo e($selectedYear); ?></span>
                                    </button>
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <li>
                                            <a href="javascript:void(0);" class="dropdown-item year-filter <?php echo e($year == $selectedYear ? 'active' : ''); ?>" data-year="<?php echo e($year); ?>"><?php echo e($year); ?></a>
                                        </li>
                        ...
                        <div class="card-body">
                            <div id="sales_charts" class="chart-initialized" data-chart-months="<?php echo e(json_encode($chartData['months'] ?? [])); ?>" data-chart-data="<?php echo e(json_encode($chartData['data'] ?? [])); ?>"></div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="table-responsive dataview">
                                <table class="table dashboard-top-services">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="vertical-align: middle;"><?php echo e($index + 1); ?></td>
                                            <td class="productimgname" style="vertical-align: middle;">
                                                <a href="javascript:void(0);" class="product-img">
                                                    <i data-feather="package" style="width: 40px; height: 40px;"></i>
                                                </a>
                                                <a href="javascript:void(0);"><?php echo e($service->product_name ?? 'N/A'); ?></a>
                                            </td>
                                            <td style="vertical-align: middle; text-align: center;">
                                                ...
                                                ?>
                                                <span class="badge badge-light-info" style="color: #000000 !important; background-color: #e7f3ff !important; padding: 5px 10px !important; border-radius: 4px !important; display: inline-block !important; min-width: 30px !important; font-weight: 600 !important;"><?php echo e($orderCount); ?></span>
                                            </td>
                                            <td style="vertical-align: middle; text-align: right;">
                                                <strong>MYR <?php echo e(number_format($service->total_revenue ?? 0, 2)); ?></strong>
                                                <small class="text-muted d-block">Qty: <?php echo e(number_format($service->total_quantity ?? 0)); ?></small>
                                            </td>
                                        </tr>
                    ...
                    <div class="table-responsive dataview">
                        <table class="table dashboard-latest-orders">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="javascript:void(0);"><?php echo e($order->order_number); ?></a>
                                        <?php if(isset($viewAllStores) && $viewAllStores && $order->store): ?>
                                            <br><small class="text-muted"><i data-feather="map-pin" style="width: 12px; height: 12px;"></i> <?php echo e($order->store->name); ?></small>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <div class="productimgname">
                                            <a href="javascript:void(0);"><?php echo e($order->customer_name ?? 'N/A'); ?></a>
                                            <?php if($order->customer_email): ?>
                                                <span class="text-muted d-block" style="font-size: 12px;"><?php echo e($order->customer_email); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="badge badge-light-info"><?php echo e($order->items->count()); ?> item(s)</span>
                                        <?php if($order->items->count() > 0): ?>
                                            <div class="mt-1" style="font-size: 12px; color: #6c757d;">
                                                ...
                                                <?php if($order->items->count() > 2): ?>
                                                    +<?php echo e($order->items->count() - 2); ?> more
                                                <?php endif; ?>
                                        </div>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <strong>MYR <?php echo e(number_format($order->total, 2)); ?></strong>
                                    </td>
                                    <td>
                                        <?php
                                        ...
                                        ?>
                                        <span class="badge <?php echo e($statusClass); ?>" style="color: #000000 !important; padding: 5px 10px !important; border-radius: 4px !important; display: inline-block !important; font-weight: 600 !important; background-color: <?php echo e($order->order_status == 'completed' ? '#d4edda' : ($order->order_status == 'pending' ? '#fff3cd' : ($order->order_status == 'cancelled' ? '#f8d7da' : '#e7f3ff'))); ?> !important;"><?php echo e($statusText); ?></span>
                                    </td>
                                    <td><?php echo e($order->created_at->format('d M Y')); ?></td>
                                    <td class="action-table-data">
                                        <div class="edit-delete-action">
                                            <a class="me-2 p-2" href="<?php echo e(route('purchase-list')); ?>" title="View Orders">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laundry\resources\views/index.blade.php ENDPATH**/ ?>