                                    ...
                                    <div class="input-blocks">
                                        ...
                                        <select class="select" id="filter_role">
                                            ...
                                            <?php $__currentLoopData = $roles ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e(ucfirst(str_replace('_', ' ', $role->name))); ?>"><?php echo e(ucfirst(str_replace('_', ' ', $role->name))); ?></option>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="userimgname">
                                            <a href="javascript:void(0);" class="userslist-img bg-img">
                                                <img src="<?php echo e(URL::asset('/build/img/users/user-01.jpg')); ?>" alt="user">
                                            </a>
                                            <div>
                                    ...
                                    <td>
                                        ...
                                        <?php echo e($role ? ucfirst(str_replace('_', ' ', $role->name)) : 'N/A'); ?>
                                    ...
                                    <td class="action-table-data">
                                        <div class="edit-delete-action">
                                            <a class="me-2 p-2 mb-0" href="javascript:void(0);" onclick="viewUser(<?php echo e($user->id); ?>)">
                                                <i data-feather="eye" class="action-eye"></i>
                                            </a>
                                            <a class="me-2 p-2 mb-0" href="javascript:void(0);" onclick="editUser(<?php echo e($user->id); ?>)">
                                                <i data-feather="edit" class="feather-edit"></i>
                                            </a>
                                            <?php if($user->id != auth()->id() && !$user->isSuperAdmin()): ?>
                                            <a class="me-2 confirm-text p-2 mb-0" href="javascript:void(0);" onclick="deleteUser(<?php echo e($user->id); ?>)">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laundry\resources\views/users.blade.php ENDPATH**/ ?>