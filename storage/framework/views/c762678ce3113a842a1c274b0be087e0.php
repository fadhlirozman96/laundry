        ...
        <div class="content">
            <div class="welcome d-lg-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center welcome-text">
                    <h3 class="d-flex align-items-center"><img src="<?php echo e(URL::asset('/build/img/icons/hi.svg')); ?>"
            ...
            <div class="row sales-cards">
                <div class="col-xl-6 col-sm-12 col-12">
                    <div class="card d-flex align-items-center justify-content-between default-cover mb-4">
                        ...
                        <img src="<?php echo e(URL::asset('/build/img/icons/weekly-earning.svg')); ?>" alt="img">
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 col-12">
                    <div class="card color-info bg-primary mb-4">
                        <img src="<?php echo e(URL::asset('/build/img/icons/total-sales.svg')); ?>" alt="img">
                ...
                <div class="col-xl-3 col-sm-6 col-12">
                    <div class="card color-info bg-secondary mb-4">
                        <img src="<?php echo e(URL::asset('/build/img/icons/purchased-earnings.svg')); ?>" alt="img">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="product-info">
                                                    <a href="<?php echo e(url('product-list')); ?>" class="product-img">
                                                        <img src="<?php echo e(URL::asset('/build/img/products/stock-img-01.png')); ?>"
                                                            alt="product">
                                                    </a>
                                                    <div class="info">
                                                        <a href="<?php echo e(url('product-list')); ?>">Lenovo 3rd Generation</a>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="product-info">
                                                    <a href="<?php echo e(url('product-list')); ?>" class="product-img">
                                                        <img src="<?php echo e(URL::asset('/build/img/products/stock-img-06.png')); ?>"
                                                            alt="product">
                                                    </a>
                                                    <div class="info">
                                                        <a href="<?php echo e(url('product-list')); ?>">Bold V3.2</a>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="product-info">
                                                    ...
                                                    <div class="info">
                                                        <a href="<?php echo e(url('product-list')); ?>">Nike Jordan</a>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="product-info">
                                                    ...
                                                    <div class="info">
                                                        <a href="<?php echo e(url('product-list')); ?>">Apple Series 5 Watch</a>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="product-info">
                                                    <a href="<?php echo e(url('product-list')); ?>" class="product-img">
                                                        <img src="<?php echo e(URL::asset('/build/img/products/stock-img-04.png')); ?>"
                                                            alt="product">
                                                    </a>
                                                    <div class="info">
                                                        <a href="<?php echo e(url('product-list')); ?>">Amazon Echo Dot</a>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="product-info">
                                                    ...
                                                    <div class="info">
                                                        <a href="<?php echo e(url('product-list')); ?>">Lobar Handy</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="product-info">
                                                    <a href="<?php echo e(url('product-list')); ?>" class="product-img">
                                                        <img src="<?php echo e(URL::asset('/build/img/products/expire-product-01.png')); ?>"
                                                            alt="product">
                                                    </a>
                                                    <div class="info">
                                                        <a href="<?php echo e(url('product-list')); ?>">Red Premium Handy</a>
                                                        <span class="dull-text d-flex align-items-center"><i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="product-info">
                                                    <a href="<?php echo e(url('product-list')); ?>" class="product-img">
                                                        <img src="<?php echo e(URL::asset('/build/img/products/expire-product-02.png')); ?>"
                                                            alt="product">
                                                    </a>
                                                    <div class="info">
                                                        <a href="<?php echo e(url('product-list')); ?>">Iphone 14 Pro</a>
                                                        <span class="dull-text d-flex align-items-center"><i
                                                                data-feather="clock" class="feather-14"></i>10 Mins</span>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="product-info">
                                                    <a href="<?php echo e(url('product-list')); ?>" class="product-img">
                                                        <img src="<?php echo e(URL::asset('/build/img/products/expire-product-03.png')); ?>"
                                                            alt="product">
                                                    </a>
                                                    <div class="info">
                                                        <a href="<?php echo e(url('product-list')); ?>">Black Slim 200</a>
                                                        <span class="dull-text d-flex align-items-center"><i
                                                                data-feather="clock" class="feather-14"></i>10 Mins</span>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="product-info">
                                                    <a href="<?php echo e(url('product-list')); ?>" class="product-img">
                                                        <img src="<?php echo e(URL::asset('/build/img/products/expire-product-04.png')); ?>"
                                                            alt="product">
                                                    </a>
                                                    <div class="info">
                                                        <a href="<?php echo e(url('product-list')); ?>">Woodcraft Sandal</a>
                                                        <span class="dull-text d-flex align-items-center"><i
                                                                data-feather="clock" class="feather-14"></i>15 Mins</span>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laundry\resources\views/sales-dashboard.blade.php ENDPATH**/ ?>