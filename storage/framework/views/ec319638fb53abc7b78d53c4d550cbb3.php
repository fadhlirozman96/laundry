...
<div class="page-wrapper">
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="<?php echo e(route('laundry.orders')); ?>" class="btn btn-secondary">
...
<!-- Garment Types Data -->
<script>
    var garmentTypes = <?php echo json_encode($garmentTypes, 15, 512) ?>;
</script>
...
<script>
    ...
    $('#create-order-form').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(route("laundry.store")); ?>',
            type: 'POST',
            data: $(this).serialize(),
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laundry\resources\views/laundry/create-order.blade.php ENDPATH**/ ?>