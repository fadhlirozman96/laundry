        ...
        <div class="content">
            <div class="page-header justify-content-between">
                ...
                <ul class="table-top-head">
                    ...
                    <li>
                        <a data-bs-toggle="tooltip" data-bs-placement="top" title="Refresh" href="<?php echo e(route('purchase-report')); ?>"><i data-feather="rotate-ccw"
                                class="feather-rotate-ccw"></i></a>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h4 class="mb-0">MYR <?php echo e(number_format($totalPurchaseAmount ?? 0, 2)); ?></h4>
                                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table datanew">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $purchaseData ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <label class="checkboxs">
                                            <input type="checkbox">
                                    ...
                                    <td>MYR <?php echo e(number_format($item->cost ?? 0, 2)); ?></td>
                                    <td><?php echo e(number_format($item->in_stock ?? 0)); ?></td>
                                    <td>MYR <?php echo e(number_format($item->purchase_amount ?? 0, 2)); ?></td>
                                </tr>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laundry\resources\views/purchase-report.blade.php ENDPATH**/ ?>