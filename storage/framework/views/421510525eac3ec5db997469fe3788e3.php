...
function viewSale(id) {
    $.get('<?php echo e(url("sales")); ?>/' + id, function(response) {
        if (response.success) {
...
function printSale(id) {
    window.open('<?php echo e(url("sales")); ?>/' + id + '?print=1', '_blank');
}
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laundry\resources\views/sales-list.blade.php ENDPATH**/ ?>