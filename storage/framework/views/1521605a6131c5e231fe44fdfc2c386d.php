    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h4>Edit Plan: <?php echo e($plan->name); ?></h4>
                <h6>Modify plan features and settings</h6>
            </div>
            <div class="page-btn">
                <a href="<?php echo e(route('superadmin.plans')); ?>" class="btn btn-secondary">
                    <i data-feather="arrow-left"></i> Back to Plans
                </a>
            </div>
        </div>

        <form action="<?php echo e(route('superadmin.plans.update', $plan->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" rows="3"><?php echo e($plan->description); ?></textarea>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price" class="form-control" value="<?php echo e($plan->price); ?>" step="0.01" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Annual Price (MYR)</label>
                                        <input type="number" name="annual_price" class="form-control" value="<?php echo e($plan->annual_price); ?>" step="0.01">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" name="max_stores" class="form-control" 
                                           value="<?php echo e($plan->max_stores != 'unlimited' && $plan->max_stores != -1 ? $plan->max_stores : 1); ?>" 
                                           min="1" id="max_stores_input"
                                           <?php echo e($plan->max_stores === 'unlimited' || $plan->max_stores == -1 ? 'disabled' : ''); ?>>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <input type="checkbox" name="unlimited_stores" value="1" id="unlimited_stores"
                                                   <?php echo e($plan->max_stores === 'unlimited' || $plan->max_stores == -1 ? 'checked' : ''); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="qc_level" class="form-control">
                                    <option value="basic" <?php echo e($plan->qc_level === 'basic' ? 'selected' : ''); ?>>Basic</option>
                                    <option value="standard" <?php echo e($plan->qc_level === 'standard' ? 'selected' : ''); ?>>Standard</option>
                                    <option value="advanced" <?php echo e($plan->qc_level === 'advanced' ? 'selected' : ''); ?>>Advanced</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="audit_trail_level" class="form-control">
                                    <option value="basic" <?php echo e($plan->audit_trail_level === 'basic' ? 'selected' : ''); ?>>Basic</option>
                                    <option value="full" <?php echo e($plan->audit_trail_level === 'full' ? 'selected' : ''); ?>>Full</option>
                                    <option value="none" <?php echo e($plan->audit_trail_level === 'none' ? 'selected' : ''); ?>>None</option>
                                </select>
                            </div>

                            <div class="form-group">
                                <label>Trial Days</label>
                                <input type="number" name="trial_days" class="form-control" value="<?php echo e($plan->trial_days); ?>" min="0">
                            </div>

                            <div class="form-group">
                                <label>Sort Order</label>
                                <input type="number" name="sort_order" class="form-control" value="<?php echo e($plan->sort_order); ?>" min="0">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" name="features[max_users]" class="form-control" 
                                           value="<?php echo e(isset($plan->features['max_users']) && $plan->features['max_users'] != 'unlimited' ? $plan->features['max_users'] : 5); ?>" 
                                           min="1" id="max_users_input" 
                                           <?php echo e(isset($plan->features['max_users']) && $plan->features['max_users'] === 'unlimited' ? 'disabled' : ''); ?>>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <input type="checkbox" name="features[unlimited_users]" value="1" id="unlimited_users"
                                                   <?php echo e(isset($plan->features['max_users']) && $plan->features['max_users'] === 'unlimited' ? 'checked' : ''); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" name="features[max_products]" class="form-control" 
                                           value="<?php echo e(isset($plan->features['max_products']) && $plan->features['max_products'] != 'unlimited' ? $plan->features['max_products'] : 100); ?>" 
                                           min="1" id="max_products_input"
                                           <?php echo e(isset($plan->features['max_products']) && $plan->features['max_products'] === 'unlimited' ? 'disabled' : ''); ?>>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <input type="checkbox" name="features[unlimited_products]" value="1" id="unlimited_products"
                                                   <?php echo e(isset($plan->features['max_products']) && $plan->features['max_products'] === 'unlimited' ? 'checked' : ''); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" name="features[max_orders_per_month]" class="form-control" 
                                           value="<?php echo e(isset($plan->features['max_orders_per_month']) && $plan->features['max_orders_per_month'] != 'unlimited' ? $plan->features['max_orders_per_month'] : 500); ?>" 
                                           min="1" id="max_orders_input"
                                           <?php echo e(isset($plan->features['max_orders_per_month']) && $plan->features['max_orders_per_month'] === 'unlimited' ? 'disabled' : ''); ?>>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <input type="checkbox" name="features[unlimited_orders]" value="1" id="unlimited_orders"
                                                   <?php echo e(isset($plan->features['max_orders_per_month']) && $plan->features['max_orders_per_month'] === 'unlimited' ? 'checked' : ''); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="features[customer_support]" class="form-control">
                                    <option value="email" <?php echo e(isset($plan->features['customer_support']) && $plan->features['customer_support'] === 'email' ? 'selected' : ''); ?>>Email Support</option>
                                    <option value="priority_email" <?php echo e(isset($plan->features['customer_support']) && $plan->features['customer_support'] === 'priority_email' ? 'selected' : ''); ?>>Priority Email</option>
                                    <option value="phone_priority" <?php echo e(isset($plan->features['customer_support']) && $plan->features['customer_support'] === 'phone_priority' ? 'selected' : ''); ?>>Phone + Priority</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="feature-item" data-feature="sop_module">
                                ...
                                <input class="feature-checkbox" type="checkbox" name="has_sop_module" value="1" id="sop_module" <?php echo e($plan->has_sop_module ? 'checked' : ''); ?>>
                            ...
                            <div class="feature-item" data-feature="store_switcher">
                                ...
                                <input class="feature-checkbox" type="checkbox" name="has_store_switcher" value="1" id="store_switcher" <?php echo e($plan->has_store_switcher ? 'checked' : ''); ?>>
                            ...
                            <div class="feature-item" data-feature="all_stores_view">
                                ...
                                <input class="feature-checkbox" type="checkbox" name="has_all_stores_view" value="1" id="all_stores_view" <?php echo e($plan->has_all_stores_view ? 'checked' : ''); ?>>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="feature-item" data-feature="laundry_qc">
                                ...
                                <input class="feature-checkbox" type="checkbox" name="features[laundry_qc]" value="1" id="laundry_qc" 
                                       <?php echo e(((isset($plan->features['laundry_qc']) && $plan->features['laundry_qc']) || in_array($plan->qc_level, ['full', 'full_sop', 'advanced'])) ? 'checked' : ''); ?>>
                            ...
                            <div class="feature-item" data-feature="machine_tracking">
                                ...
                                <input class="feature-checkbox" type="checkbox" name="features[machine_tracking]" value="1" id="machine_tracking" <?php echo e((isset($plan->features['machine_tracking']) && $plan->features['machine_tracking']) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="feature-item" data-feature="advanced_reporting">
                                ...
                                <input class="feature-checkbox" type="checkbox" name="features[advanced_reporting]" value="1" id="advanced_reporting" <?php echo e((isset($plan->features['advanced_reporting']) && $plan->features['advanced_reporting']) ? 'checked' : ''); ?>>
                            ...
                            <div class="feature-item" data-feature="api_access">
                                ...
                                <input class="feature-checkbox" type="checkbox" name="features[api_access]" value="1" id="api_access" <?php echo e((isset($plan->features['api_access']) && $plan->features['api_access']) ? 'checked' : ''); ?>>
                            ...
                            <div class="feature-item" data-feature="landing_page_module">
                                ...
                                <input class="feature-checkbox" type="checkbox" name="features[landing_page_module]" value="1" id="landing_page_module" <?php echo e((isset($plan->features['landing_page_module']) && $plan->features['landing_page_module']) ? 'checked' : ''); ?>>
                            ...
                            <div class="feature-item" data-feature="theme_customization">
                                ...
                                <input class="feature-checkbox" type="checkbox" name="features[theme_customization]" value="1" id="theme_customization" <?php echo e((isset($plan->features['theme_customization']) && $plan->features['theme_customization']) ? 'checked' : ''); ?>>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-end">
                        <a href="<?php echo e(route('superadmin.plans')); ?>" class="btn btn-secondary me-2">Cancel</a>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laundry\resources\views/superadmin/plans-edit.blade.php ENDPATH**/ ?>