...
<div class="sidebar horizontal-sidebar">
    <div id="sidebar-menu-3" class="sidebar-menu">
        <ul class="nav">
            ...
            <li class="submenu">
                <a href="javascript:void(0);"
                    class="{{ Request::is('sales-report', 'purchase-report', 'inventory-report', 'invoice-report', 'supplier-report', 'customer-report', 'expense-report', 'income-report', 'tax-reports', 'profit-loss') ? 'active subdrop' : '' }}"><img
                ...
                <ul>
                    ...
                    <li><a class="{{ Request::is('tax-reports') ? 'active' : '' }}"
                            href="{{ url('tax-reports') }}"><span>Tax
                                Report</span></a></li>
                    <li><a class="{{ Request::is('profit-loss') ? 'active' : '' }}"
                            href="{{ route('profit-loss') }}"><span>Profit &
                                Loss</span></a></li>
                </ul>
            </li>
            <li class="submenu">
