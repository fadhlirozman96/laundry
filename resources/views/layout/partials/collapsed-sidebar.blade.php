        ...
        <div id="sidebar-menu-2" class="sidebar-menu sidebar-menu-three">
            <aside id="aside" class="ui-aside">
                <ul class="tab nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="tablinks nav-link {{ Request::is('sales-report', 'purchase-report', 'inventory-report', 'invoice-report', 'supplier-report', 'customer-report', 'expense-report', 'income-report', 'tax-reports', 'profit-loss') ? 'active' : '' }}" href="#set3" id="set-tab3" data-bs-toggle="tab"
            ...
            <div class="tab-content tab-content-four pt-2">
                ...
                <ul class="tab-pane {{ Request::is('sales-report', 'purchase-report', 'inventory-report', 'invoice-report', 'supplier-report', 'customer-report', 'expense-report', 'income-report', 'tax-reports', 'profit-loss') ? 'active' : '' }}"
                    ...
                    <li><a href="{{ route('profit-loss') }}"
                            class="{{ Request::is('profit-loss') ? 'active' : '' }}"><span>Profit &
                                Loss</span></a></li>
                </ul>
