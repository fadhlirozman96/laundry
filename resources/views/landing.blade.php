...
<link rel="icon" href="{{ asset('landing/assets/images/favicon.png') }}" type="image/x-icon">
<!-- Responsive -->
...
<div class="page-wrapper">
	...
	<header class="main-header header-style-two">
        <div class="header-lower">
            <div class="container">
                ...
                <div class="main-box">
                    <div class="logo-box">
                        <div class="logo"><a href="{{ url('/') }}"><img src="{{ asset('landing/assets/images/logo-2.svg') }}" alt="" title="Rapy"></a></div>
                    </div>
                    ...
                    <div class="outer-box">
                        <div class="btn">
                            <a href="{{ route('login') }}" class="theme-btn v2">Login</a>
                        </div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="upper-box">
                    <div class="nav-logo"><a href="{{ url('/') }}"><img src="{{ asset('landing/assets/images/logo.png') }}" alt="" title=""></a></div>
        ...
        <div class="sticky-header">
            <div class="container">
                <div class="inner-container">
                    <!--Logo-->
                    <div class="logo">
                        <a href="{{ url('/') }}" title=""><img src="{{ asset('landing/assets/images/logo.png') }}" alt="" title=""></a>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 col-md-12 col-sm-12">
                    <div class="banner-text-v2">
                        ...
                        <div class="btn-box wow fadeInUp" data-wow-delay="300ms">
                            <a href="{{ route('login') }}" class="theme-btn">Get Started</a>
                        </div>
                        <div class="rating-sec">
                            ...
                            <span class="contact"><img src="{{ asset('landing/assets/images/icons/phone.svg') }}" alt="" /> Phone:  +60 12-345-6789</span>
                        </div>
                    </div>
                </div>
                <!-- image-column -->
                <div class="col-lg-5">
                    <div class="banner-img-v2">
                        <img src="{{ asset('landing/assets/images/resource/banner1-3.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="about-img-v2 wow fadeInLeft">
                        <img src="{{ asset('landing/assets/images/resource/about1-1.png') }}" alt="">
                    </div>
                </div>
                <!-- content-column -->
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="about-content wow fadeInRight">
                        ...
                        <div class="content-box">
                            ...
                            <a href="{{ route('login') }}" class="about-btn theme-btn">Start Your Free Trial</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="fact-box">
                <div class="fact-content wow fadeInUp">
                    ...
                    <a href="{{ route('login') }}" class="fac-btn theme-btn">Start Free Trial</a>
                </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="feature-text">
                        ...
                        <div class="image-box wow fadeInUp">
                            <figure class="image"><img src="{{ asset('landing/assets/images/resource/feature1-1.png') }}" alt=""></figure>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="content-box-two wow fadeInUp" data-wow-delay="400ms">
                            <div class="rating-sec">
                                ...
                                <a href="{{ route('login') }}" class="choose-btn theme-btn">Try It Free</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 col-lg-12 col-md-12 col-sm-12">
                            <div class="growth-column wow fadeInUp">
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="btn-box">
                                        <a href="{{ route('login') }}" class="theme-btn">Get Started Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-5 col-lg-12 col-md-12 col-sm-12">
                            <div class="image-box wow fadeInRight">
                                <figure class="image"><img src="{{ asset('landing/assets/images/resource/grwoth1-1.png') }}" alt=""></figure>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="pricin-block-two active">
                                            ...
                                            <div class="content-box">
                                                ...
                                                <a href="{{ route('login') }}" class="choose-btn theme-btn">Get Started</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- pricin-block-two -->
        ...
        <div class="container">
            ...
            <div class="outer-box">
                <ul class="member-list active">
                    <li class="circle"></li>
                    <li><div class="image-box"><img src="{{ asset('landing/assets/images/resource/client1-1.png') }}" alt=""></div></li>
                    <li class="two"><div class="image-box"><img src="{{ asset('landing/assets/images/resource/client1-2.png') }}" alt=""></div></li>
                    <li class="three"><div class="image-box"><img src="{{ asset('landing/assets/images/resource/client1-3.png') }}" alt=""></div></li>
                    <li class="circle two"></li>
                </ul>
                <ul class="member-list two">
                    <li class="circle two"></li>
                    <li class="four"><div class="image-box"><img src="{{ asset('landing/assets/images/resource/client1-4.png') }}" alt=""></div></li>
                    <li class="five"><div class="image-box"><img src="{{ asset('landing/assets/images/resource/client1-5.png') }}" alt=""></div></li>
                    <li class="six"><div class="image-box"><img src="{{ asset('landing/assets/images/resource/client1-6.png') }}" alt=""></div></li>
                    <li class="circle"></li>
                </ul>
            </div>
        </div>
    ...
    <footer class="main-footer footer-style-two" id="contact">
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="inner-container">
                    <div class="copyright-text">Copyright {{ date('Y') }} <a href="{{ url('/') }}" title="">Rapy</a>. All rights reserved.</div>
                    <ul class="footer-nav">
...
<script src="{{ asset('landing/assets/js/slick-animation.min.js') }}"></script>
<script src="{{ asset('landing/assets/js/jquery.fancybox.js') }}"></script>
